...
const menuItems = [
    ...
    },
    {
        imgSrc: '/assets/menu/coffee-1.png',
        name: 'Macchiato',
        description: 'Espresso with a dollap of foam',
        price:3.75
    },
    {
        imgSrc: '/assets/menu/coffee-2.png',
    ...
    <section className='pt-12 pb-16 xl:pt-16 xl:pb-36'>
        <div className="container mx-auto">
            <div className='flex flex-col gap-4 mb-12 xl:mb-24'>
                ...
                <p className='text-center max-w-[620px] mx-auto'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et nemo temporibus corrupti consequatur enim hic autem a laborum. Laudantium dolorum perspiciatis tempore eos eum assumenda dolores necessitatibus porro modi praesentium?</p>
            </div>
            {/* menu and btn */}
            ...
            <div className='w-full grid grid-cols-1 xl:grid-cols-2 gap-y-8 gap-x-16'>
                {menuItems.map((item, index)=>{
                    ...
                    return (
                        <MenuItem key={index} name={name} description={description} imgSrc={imgSrc} price={price}/>
                    )
                })}
            </div>
