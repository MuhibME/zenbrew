    ...
    <header className='absolute top-[40px] left-0 right-0 z-[60] '>
        <div className="container mx-auto">
            <div className='flex justify-between items-center'>
                {/* logo */}
                <Link href='/' className='relative w-[100px] h-[40px] xl:h-[40px] xl:w-[120px] z-[60px]'>
                ...
                <button onClick={()=> setNavActive(!navActive)} className='w-8 h-6 text-accent relative flex items-center justify-center z-[60] outline-none'>
                    ...
                    <span className={`w-full h-[1.5px] bg-current absolute left-0 will-change-transform transition-transform duration-300 ${navActive ? 'opacity-0' : 'top-1/2'}`}></span>
